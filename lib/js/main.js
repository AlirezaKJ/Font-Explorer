...
function slidedata(titleicon,titletext, content) {
    document.getElementById("slidetitleicon").innerHTML = titleicon;
    document.getElementById("slidetitletext").innerHTML = titletext;
    document.getElementById("slidecontent").innerHTML = content;
}

function home() {
    slidedata(HOMESVG,"Home", `Welcome to Font Explorer V${VERSION}`);
...
function explore() {
    slidedata(EXPLORESVG,"Explore", "Explore fonts");
    sidebaritems.forEach(element => {
        element.classList.remove("toggleditem")
    })
...
function setting() {
    slidedata(SETTINGSSVG,"Settings", "change basic settings");
    sidebaritems.forEach(element => {
        element.classList.remove("toggleditem")
    })
